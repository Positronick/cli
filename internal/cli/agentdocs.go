...
const agentDocsIntro = "`positronick` is the command-line client for positronick.com. It discovers agent " +
	...
	"never prompt. Hidden admin commands (create/update for souls and listings) exist and " +
	"appear in help and in these docs after logging in with an admin account."
